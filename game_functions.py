...
def check_events(ai_settings, screen, stats, scoreboard, plat_buttion, ship, aliens, bullets):
    """响应按键和鼠标事件"""
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, screen, stats, scoreboard, plat_buttion, ship, aliens, bullets, mouse_x, mouse_y)
...
def get_number_rows(ai_setttings, ship_height, alien_height):
    """计算屏幕可容纳多少行外星人"""
    available_space_y = (ai_setttings.screen_height -
